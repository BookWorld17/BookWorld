...
public class addBookActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(checkData() ){
                    ...
                    String errMsg = getString(R.string.Please_insert_book_data);
        ...
        RecyclerView rv_tagsList = (RecyclerView) findViewById(R.id.rv_tagsList);

        tagsList = new ArrayList<>();
        tagsList.add(new Tags("0", "All", false));
        for(Tags t : URLs.tegsList ){
            tagsList.add(new Tags(t.getId(), t.getName(), false));
        }
        adapterTags = new tagsAdapter(tagsList, this);


        rv_tagsList.setHasFixedSize(true);
        rv_tagsList.setLayoutManager(new GridLayoutManager(getApplicationContext(), 3));
        rv_tagsList.setAdapter(adapterTags);
        ...
        if(extras != null)
        {
            if(extras.containsKey("book")){
                ...
                interface_title.setText(getString(R.string.edit) + book.getBookName());
    ...
    private boolean checkData() {
        ...
        if (pName.isEmpty() || pName.length() < 3) {
            bookName.setError(getString(R.string.book_name_length));
            valid = false;
        } else {
        ...
        if (summaryText.isEmpty()  ) {
            summary.setError(getString(R.string.write_some_description));
            valid = false;
        } else {
        ...
        if(uploadedImage == null){
            Toast.makeText(addBookActivity.this, getString(R.string.select_an_image), Toast.LENGTH_LONG).show();
            valid = false;
        }
        ...
        for(int i = 0; i< tagsList.size(); i++)
        {
            if(tagsList.get(i).isSelected()){
                bookTags = bookTags + tagsList.get(i).getId() + ";";
            }
        }
        if(bookTags.equals("")){
            Toast.makeText(addBookActivity.this, getString(R.string.select_tage), Toast.LENGTH_LONG).show();
            bookTags = "";
            valid = false;
        }
    ...
    private void onUpdateSuccess() {
        alert.showAlertDialog(addBookActivity.this, "Saved",getString(R.string.saved_successfully),true,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void onUpdateFailed() {
        showMessageOKCancel(getString(R.string.Data_not_saved),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                    }
    ...
    protected void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        try {
            if (requestCode == RESULT_LOAD_IMG && resultCode == RESULT_OK && null != data) {
                ...
                Toast.makeText(this, getString(R.string.You_have_not_picked_Image), Toast.LENGTH_LONG).show();
            }
        } catch (Exception e) {
