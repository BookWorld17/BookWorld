...
public class SProfileActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert = new AlertManager(SProfileActivity.this);
        uname = (EditText) findViewById(R.id.uname);
        mail = (EditText) findViewById(R.id.mail);
        pass = (EditText) findViewById(R.id.pass);
        address = (EditText) findViewById(R.id.address);
        country = (EditText) findViewById(R.id.country);
        deliver_days = (EditText) findViewById(R.id.deliver_days);
        ...
        deliver_days.setVisibility(View.VISIBLE);
        getData();
    }
    ...
    private void update() {
        ...
        if (validation()) {
            loading = ProgressDialog.show(this, "Loading", getString(R.string.waiting), false, false);
            StringRequest stringRequest = new StringRequest(Request.Method.POST, URLs.UPDATE_PROFILE,
                    new Response.Listener<String>() {
                        ...
                        public void onResponse(String response) {
                            ...
                            Toast.makeText(SProfileActivity.this, response, Toast.LENGTH_LONG).show();
                        }
                    },
                    new Response.ErrorListener() {
                        ...
                        public void onErrorResponse(VolleyError error) {
                            loading.dismiss();
                            alert.showAlertDialog(SProfileActivity.this,
                                    "",
                ...
                protected Map<String,String> getParams(){
                    ...
                    params.put("deliver_days" , deliver_days.getText().toString() );
    ...
    public void updateAction(String response){
        ...
        try {
            ...
            if(success.equals("1")){
                ...
                alert.showAlertDialog(SProfileActivity.this, "", getString(R.string.update_profile_failed), false);
            }
    ...
    public boolean validation(){
        ...
        if (deliver_days.equals("0")) {
            deliver_days.setError(getString(R.string.deliver_days_must_set));
            deliver_days.requestFocus();
            validData = false;
        }
        ...
        try {
            ...
            if(success.equals("1")){
                for(int i=1;i<users.length();i++){
                    ...
                    String deliver_daysT = jo.getString("deliver_days");
                    uname.setText(nickName);
                    mail.setText(email);
                    address.setText(addressT);
                    deliver_days.setText(deliver_daysT);
                }
            }else{
