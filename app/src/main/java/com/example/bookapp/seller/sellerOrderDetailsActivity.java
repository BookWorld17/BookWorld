...
public class sellerOrderDetailsActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        alert = new AlertManager(sellerOrderDetailsActivity.this);
        ...
        adapter = new cartAdapter( cartArrayList , sellerOrderDetailsActivity.this);
    ...
    private void onLoadError() {
        alert.showAlertDialog(sellerOrderDetailsActivity.this,getString(R.string.error),"Cart is empty",false);
    }
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                ...
                                alert.showAlertDialog( sellerOrderDetailsActivity.this,
                                        "",
                            ...
                            if(success.equals("1")){
                                ...
                                alert.showAlertDialog(sellerOrderDetailsActivity.this,
                                        ...
                                        new DialogInterface.OnClickListener() {
                                            @Override
                                            public void onClick(DialogInterface dialogInterface, int i) {
                                                Intent intent = new Intent(sellerOrderDetailsActivity.this, ordersList.class);
