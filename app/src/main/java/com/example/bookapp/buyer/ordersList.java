...
public class ordersList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interface_title.setText(R.string.list_of_my_orders);
    ...
    private void onLoadError() {
        alert.showAlertDialog(ordersList.this,getString(R.string.fav_is_empty),getString(R.string.No_data_Available),false);
    }
