...
public class favoriteList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interface_title.setText(getString(R.string.my_fav_books));
    ...
    private void onLoadError() {
        alert.showAlertDialog(favoriteList.this,getString(R.string.fav_is_empty),getString(R.string.No_data_Available),false);
    }
    ...
    public void removeItem(Book book) {
        alert.showMessageOKCancel(getString(R.string.confirm_remove), new DialogInterface.OnClickListener() {
            @Override
