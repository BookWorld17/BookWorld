...
public class orderDetailsActivity extends BaseActivity {
    ...
    private void onLoadError() {
        alert.showAlertDialog(orderDetailsActivity.this,getString(R.string.error),getString(R.string.cart_is_empty),false);
    }
                ...
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                alert.showAlertDialog(orderDetailsActivity.this,getString(R.string.success),getString(R.string.success_review), true);

                            }else{
                                alert.showAlertDialog(orderDetailsActivity.this,getString(R.string.error),getString(R.string.already_review), false);
                            }
                        } catch (JSONException e) {
                            alert.showAlertDialog(orderDetailsActivity.this,getString(R.string.error),getString(R.string.Could_not_post_review), false);
                        }
                    }
                },
                new Response.ErrorListener() {
