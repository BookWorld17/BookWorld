...
public class BuyerMainActivity extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        recyclerView.setLayoutManager(new GridLayoutManager(getApplicationContext(),  URLs.categoriesList.size() ));
    ...
    private void onLoadError() {
        ...
        if(type.equals("search")) {
            interface_title.setText(interface_title.getText()+getString(R.string.No_results_found));
