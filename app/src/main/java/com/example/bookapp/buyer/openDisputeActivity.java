...
public class openDisputeActivity extends BaseActivity {
        ...
        saveBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                ...
                if(checkData() ){
                    ...
                    String errMsg = getString(R.string.insert_book_data);
    ...
    private boolean checkData() {
        ...
        if (summaryText.isEmpty()  ) {
            summary.setError(getString(R.string.description_required));
            valid = false;
        } else {
        ...
        if(uploadedImage == null){
            Toast.makeText(openDisputeActivity.this, getString(R.string.image_required), Toast.LENGTH_LONG).show();
            valid = false;
        }
    ...
    private void onUpdateSuccess() {
        alert.showAlertDialog(openDisputeActivity.this, getString(R.string.Saved),getString(R.string.dispute_sucess_saved),true,
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
    ...
    private void onUpdateFailed() {
        showMessageOKCancel(getString(R.string.dispute_note_saved),
                new DialogInterface.OnClickListener() {
                    @Override
                    public void onClick(DialogInterface dialog, int which) {
                    }
