...
public class disputeList extends BaseActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        interface_title.setText(getString(R.string.list_of_my_disputes));
    ...
    private void onLoadError() {
        alert.showAlertDialog(disputeList.this,getString(R.string.error),getString(R.string.No_data_Available),false);
    }
