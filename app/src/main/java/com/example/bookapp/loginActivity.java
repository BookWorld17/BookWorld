...
public class loginActivity extends Activity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
            ...
            public void onClick(View arg0) {
                ...
                if(emailTxt.trim().length() > 0 && password.trim().length() > 0){
                    ...
                    alert.showAlertDialog(loginActivity.this,
                            "",
                            getString(R.string.wrong_inputs),
                            false);
                }
        ...
        emailAdmin.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View arg0) {
                if(!email.getText().toString().equals("")) {
                    URLs.adminEmail(loginActivity.this, email.getText().toString());
                }else{
                    alert.showAlertDialog(loginActivity.this,
                            "",
        ...
        TextView forgetLBL = (TextView) findViewById(R.id.forgetPass);
        forgetLBL.setOnClickListener(new View.OnClickListener() {
                    ...
                    public void onResponse(String response) {
                        ...
                        try {
                            ...
                            if(success.equals("1")){
                                ...
                                alert.showAlertDialog( loginActivity.this,
                                        "",getString(R.string.invalid_user),false);
                            }
