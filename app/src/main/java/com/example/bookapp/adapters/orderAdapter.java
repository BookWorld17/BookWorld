...
public class orderAdapter extends RecyclerView.Adapter<orderAdapter.MyViewHolder> {
 ...
 //       holder.book_name.setText(item.getBook().getBookName() );
    ...
    private void cancelOrder(Order item, String userType) {
        ...
        final ProgressDialog loading = ProgressDialog.show(context, context.getString(R.string.Loading), context.getString(R.string.waiting), false, false);
        ...
        StringRequest stringRequest = new StringRequest(Request.Method.POST, request,
                new Response.Listener<String>() {
                    ...
                    public void onResponse(String response) {
                        loading.dismiss();
                        Toast.makeText(context, context.getString(R.string.Order_Canceled), Toast.LENGTH_LONG).show();
                ...
                new Response.ErrorListener() {
                    ...
                    public void onErrorResponse(VolleyError error) {
                        ...
                        loading.dismiss();
                        Toast.makeText(context, context.getString(R.string.Couldn_not_cancel_order), Toast.LENGTH_LONG).show();
                    }
                }){
            @Override
