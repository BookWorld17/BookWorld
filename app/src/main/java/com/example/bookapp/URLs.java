...
public  class URLs {
    ...
    public static final String GET_ALL_TAGS = SERVER + "get_all_tags.php";
    public static final String CANCEL_ORDER = SERVER + "cancelOrder.php";;
    public static final String FORGET_PASS = SERVER + "forgetPassword.php";;

    public static ArrayList<Category> categoriesList = new ArrayList<>();
    public static ArrayList<Tags> tegsList = new ArrayList<>();
